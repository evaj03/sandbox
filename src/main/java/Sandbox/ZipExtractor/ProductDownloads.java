 ...
 *         &lt;element ref="{}tranche" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "product-downloads")
public class ProductDownloads {

    protected List<Release> release;
    protected List<Tranche> tranche;
     ...
     * 
     */
    public List<Tranche> getTranche() {
        if (tranche == null) {
            tranche = new ArrayList<Tranche>();
        }
        return this.tranche;
    }
